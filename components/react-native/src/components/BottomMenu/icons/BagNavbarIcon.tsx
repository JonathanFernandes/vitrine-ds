...
/** Default (outline) variant of the bag/store icon. */
export function BagNavbarIcon({ color, size = 24 }: IconProps) {
  return (
...
/** Active (filled) variant of the bag/store icon. */
export function BagNavbarFilledIcon({ color, size = 24 }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
